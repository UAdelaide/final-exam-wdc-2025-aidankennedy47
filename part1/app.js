...
app.get('/api/walkers/summary', async (req, res) => {
  try {
    const [walkers] = await db.execute(`SELECT u.username AS walker_username, COUNT(wrate.rating), wrate.average(rating), wreq.count(IF status = 'completed') AS walks_completed
         FROM Users u
